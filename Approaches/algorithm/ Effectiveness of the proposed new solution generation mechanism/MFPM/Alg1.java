...
import MFMR.DefParaTbl;
import MFMR.FPTree;
import MFMR.Individual;
import MFMR.Population;
...
public class Alg1 {
    ...
    private MFMR.DefParaTbl fpgaDefParaTbl;//缺省的参数表
    private MFMR.DefParaTbl fpgaCurParaTbl;//当前的参数表
    ...
    public void init() throws IOException, ClassNotFoundException {
        ...
        fpgaDefParaTbl = MFMR.DefParaTbl.getFPGA1DefParaTbl(defParas);
