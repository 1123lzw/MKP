...
public class Alg1 {
    ...
    public void init() throws IOException, ClassNotFoundException {
        List<DefPara> defParas=getDefParas("MFUCAlg");
    ...
    public void addRunRcd(String probName) throws IOException {
        ...
        AlgRunRcd aAlgRunRcd = new AlgRunRcd("MFUCAlg", probName, -1, curTime, curTime);
    ...
    public void run(MKPProb problem, Double time) throws IOException, ClassNotFoundException {
        ...
        while(!stopFlag ){
            ...
            population.genPoplationUn();
            curTime = System.currentTimeMillis();

            addGenBestInfo(probName,gen,population.getBestIndividual());
            gen=gen+1;
        }
        stopRun("MFUCAlg",probName, curRunID,curTime);
        curRunID++;
    }
