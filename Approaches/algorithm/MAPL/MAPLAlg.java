...
public class MAPLAlg {
    ...
    public void init() throws IOException, ClassNotFoundException {
        List<DefPara> defParas=getDefParas("MAPL");
    ...
    public void addRunRcd(String probName) throws IOException {
        ...
        AlgRunRcd aAlgRunRcd = new AlgRunRcd("MAPL", probName, -1, curTime, curTime);
    ...
    public void run(MKPProb solvePro,double time)throws IOException, ClassNotFoundException{
        ...
        Long curTime = System.currentTimeMillis();
        stopRun("MAPLAlg",probName, curRunID,curTime);
        curRunID++;
