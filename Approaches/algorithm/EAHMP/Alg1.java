...
public class Alg1 {
    ...
    public void init() throws IOException, ClassNotFoundException {
        ...
        fpgaDefParaTbl = FPGA1DefParaTbl.getFPGA1DefParaTbl(defParas);
        fpgaCurParaTbl=new FPGA1DefParaTbl(fpgaDefParaTbl);//复制参数表
    }
    public void addRunRcd(String probName) throws IOException {
        ...
        AlgRunRcd aAlgRunRcd = new AlgRunRcd("FPGAlgM3", probName, -1, curTime, curTime);
    ...
    public void run(MKPProb problem,Double time) throws IOException, ClassNotFoundException {
        ...
        stopRun("FPGAlg",probName, curRunID,curTime);
        curRunID++;
    }
